...
async function getAllGrades() {
  ...
  //Set(); simula conjuntos, não podem se repetir
  ...
  //ordenação é feita de tras pra frente...
  //logo, a ordenação correta é studentLowerCase, subjectLowerCase, typeLowerCase
